...
uses Winapi.Windows, Winapi.Messages, System.Classes, System.UITypes, Vcl.Controls, Vcl.Forms, Vcl.Graphics,
...
begin
  ...
  if (FWicBuffer <> nil) and (FWicBufferDisabled <> nil) and (FControl <> nil) then
  begin
...
begin
  ...
  else if Focused or TBitBtn(Control).Default then
